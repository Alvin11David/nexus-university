...
urlpatterns = [
    ...
    path("assignments/<int:assignment_id>/update/", AssignmentUpdateView.as_view()),
    ...
    path("submissions/<int:submission_id>/update/", SubmissionUpdateView.as_view()),
    path("profiles/by-user/<str:user_id>/", ProfileUpdateByUserView.as_view()),
